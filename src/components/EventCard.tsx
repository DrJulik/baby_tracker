        ...
        <div className="flex items-center gap-0.5">
          {onEdit && (
            <button
              ...
              className="opacity-100 sm:opacity-0 sm:group-hover:opacity-100 p-1.5 rounded-lg hover:bg-accent/10 text-ink-soft hover:text-accent transition-all duration-200 cursor-pointer"
